...
class _CarMenuScreenState extends State<CarMenuScreen> {
  List<Map<String, String>> cars = [
    {
      'title': 'USDTC', 
      'image': 'assets/16PM.jpg',
      'description': 'Описание usdtc: рисковый, но может оказаться фартовым.'
    },
    {
      'title': 'ETH',
      'image': 'assets/15PM.jpg',
      'description': 'Описание eth: лучшая монета для перелива средств просле основного цикла btc.'
    },
    {
      'title': 'ATOM', 
      'image': 'assets/15.png',
      'description': 'Описание atom: идеален на перспективу web3.'
    },
    {
      'title': 'BTC',
      'image': 'assets/13.jpg',
      'description': 'Описание btc: идеален для долгосрока.'
    },
  ];
